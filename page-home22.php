    ...
    <div id="myModal" class="modal">
      ...
      <div class="modal-content">
        ...
        <div style="width: 50%;flex-basis: 50%; text-align: center; margin-bottom: 30px;">
           <a class="btn-text" style="text-decoration: none; color: #9e0e30; background-color: #fdfeff; padding: 10px 15px; border: 1px solid #9e0e30; border-radius: 5px;" href='https://xn--80ahyflx1k.xn--j1amh/ru/glavnaya/'>Продовжити</a>
        </div>
        <div style="width: 50%;flex-basis: 50%; text-align: center; margin-bottom: 30px;">
            <a class="btn-text" style="text-decoration: none; color: #9e0e30; background-color: #fdfeff; padding: 10px 15px; border: 1px solid #9e0e30; border-radius: 5px;" href='https://xn--80ahyflx1k.xn--j1amh/ua/golovna/'>Читати українською</a>
        </div>
      </div>
